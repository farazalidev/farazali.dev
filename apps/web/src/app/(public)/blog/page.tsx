...
const BlogPage: React.FC<BlogPageProps> = () => {
    return (
        <div className='h-full text-primary-text grid gap-2 grid-cols-12'>
            <SideBar className={cn('md:col-span-2 lg:col-span-1 xl:col-span-1 hidden md:flex')} />
            <RecentPosts className='col-span-12 md:col-span-10 lg:col-span-11 xl:col-span-7' />
